...
export default function App(): JSX.Element {
  ...
  // ~90s of student inactivity and ask the main process to have the interviewer speak
  // a check-in. Capped at 2 nudges per idle stretch (reset by markStudentActivity).
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      if (idle >= 90_000 && nudgeCountRef.current < 2) {
